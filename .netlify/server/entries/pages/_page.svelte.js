import { c as create_ssr_component, h as compute_rest_props, g as getContext, i as spread, j as escape_attribute_value, k as escape_object, s as setContext, v as validate_component } from "../../chunks/ssr.js";
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div id="home-container"><div id="home-title" data-svelte-h="svelte-1emcmxh">Welcome to Gartic Phone</div> <div>${validate_component(ButtonGroup, "ButtonGroup").$$render($$result, { class: "space-x-px" }, {}, {
    default: () => {
      return `${validate_component(Button, "Button").$$render($$result, { pill: true, color: "purple" }, {}, {
        default: () => {
          return `Join Lobby`;
        }
      })} ${validate_component(Button, "Button").$$render($$result, { pill: true, color: "purple" }, {}, {
        default: () => {
          return `Create Lobby`;
        }
      })}`;
